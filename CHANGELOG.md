...
## [2.5.0](https://github.com/grzegorzfranus/ansible-role-chrony/compare/v2.4.15...v2.5.0) (2026-08-18)


### Features

* **logrotate:** make dateformat configurable ([#63](https://github.com/grzegorzfranus/ansible-role-chrony/issues/63)) ([78b102d](https://github.com/grzegorzfranus/ansible-role-chrony/commit/78b102debf8d2224b9ee069428a860788003c1a1))

## [2.4.15](https://github.com/grzegorzfranus/ansible-role-chrony/compare/v2.4.14...v2.4.15) (2026-08-13)


### Documentation

* update remaining reusable workflow version reference to [@main](https://github.com/main) ([#60](https://github.com/grzegorzfranus/ansible-role-chrony/issues/60)) ([1eb2bf5](https://github.com/grzegorzfranus/ansible-role-chrony/commit/1eb2bf532e0f3049a0dfc72fd115cc66eda01b6e))

## [2.4.14](https://github.com/grzegorzfranus/ansible-role-chrony/compare/v2.4.13...v2.4.14) (2026-08-13)


### CI/CD

* track reusable workflows on main branch instead of pinned tag ([#57](https://github.com/grzegorzfranus/ansible-role-chrony/issues/57)) ([03d0331](https://github.com/grzegorzfranus/ansible-role-chrony/commit/03d03311e77514a9fed8c56f957493b1dd9e9125))

## [2.4.13](https://github.com/grzegorzfranus/ansible-role-chrony/compare/v2.4.12...v2.4.13) (2026-08-10)


### Bug Fixes

* reapply configuration after upgrade and honour custom log paths ([#54](https://github.com/grzegorzfranus/ansible-role-chrony/issues/54)) ([71628ee](https://github.com/grzegorzfranus/ansible-role-chrony/commit/71628ee8456ab301128f6e82eedf69d9060ad8ac))

## [2.4.12](https://github.com/grzegorzfranus/ansible-role-chrony/compare/v2.4.11...v2.4.12) (2026-08-10)


### Miscellaneous

* align lint and repository configuration ([#52](https://github.com/grzegorzfranus/ansible-role-chrony/issues/52)) ([bce5c20](https://github.com/grzegorzfranus/ansible-role-chrony/commit/bce5c20f056fc11ee76cbbb8891e80b30f44bc63))

## [2.4.11](https://github.com/grzegorzfranus/ansible-role-chrony/compare/v2.4.10...v2.4.11) (2026-08-09)


### Documentation

* align comments and README with role standards ([#50](https://github.com/grzegorzfranus/ansible-role-chrony/issues/50)) ([bd9c4ed](https://github.com/grzegorzfranus/ansible-role-chrony/commit/bd9c4edac297dd79c0ba3a5eb5f07db9b59399d5))

## [2.4.10](https://github.com/grzegorzfranus/ansible-role-chrony/compare/v2.4.9...v2.4.10) (2026-08-09)


### Bug Fixes

* correct tag inheritance and task idioms ([#48](https://github.com/grzegorzfranus/ansible-role-chrony/issues/48)) ([d21cf81](https://github.com/grzegorzfranus/ansible-role-chrony/commit/d21cf810dfec857b6d8947edb72d1403c6a425a9))

## [2.4.9](https://github.com/grzegorzfranus/ansible-role-chrony/compare/v2.4.8...v2.4.9) (2026-07-29)


### Bug Fixes

* **chrony:** implement chrony remediation plan ([#46](https://github.com/grzegorzfranus/ansible-role-chrony/issues/46)) ([a62fc1b](https://github.com/grzegorzfranus/ansible-role-chrony/commit/a62fc1bf9ee18cf487be15feb57a2f7c274673cd))

## [2.4.8](https://github.com/grzegorzfranus/ansible-role-chrony/compare/v2.4.7...v2.4.8) (2026-07-21)


### Documentation

* **tasks:** add execution flow comment to tasks main orchestrator ([#42](https://github.com/grzegorzfranus/ansible-role-chrony/issues/42)) ([386aa08](https://github.com/grzegorzfranus/ansible-role-chrony/commit/386aa08736ed84103d9056f258bee2b5a20cbb08))
...
* **34:** upgrade github workflows to v3.0.1 and update documentation ([#36](https://github.com/grzegorzfranus/ansible-role-chrony/issues/36)) ([9863d36](https://github.com/grzegorzfranus/ansible-role-chrony/commit/9863d367c430af24aa044fb66326e9a2075f243c))

## [2.4.5](https://github.com/grzegorzfranus/ansible-role-chrony/compare/v2.4.4...v2.4.5) (2026-06-29)


### Miscellaneous

* migrate workflows to github-workflows and align configuration ([#31](https://github.com/grzegorzfranus/ansible-role-chrony/issues/31)) ([28c1563](https://github.com/grzegorzfranus/ansible-role-chrony/commit/28c156345caa3db7c6ba612b35b879c18b43c071))

## [2.4.4](https://github.com/grzegorzfranus/ansible-role-chrony/compare/v2.4.3...v2.4.4) (2026-06-02)


### Code Refactoring

* standardize comments, headers, and formatting ([#27](https://github.com/grzegorzfranus/ansible-role-chrony/issues/27)) ([b20d074](https://github.com/grzegorzfranus/ansible-role-chrony/commit/b20d0741931c54d6f3196701cfd6808fa721c0b1))

## [2.4.3](https://github.com/grzegorzfranus/ansible-role-chrony/compare/v2.4.2...v2.4.3) (2026-06-01)


### Code Refactoring

* standardize comments ([#25](https://github.com/grzegorzfranus/ansible-role-chrony/issues/25)) ([d9d2e39](https://github.com/grzegorzfranus/ansible-role-chrony/commit/d9d2e39a42c7acc027ba39e64aae64ea869cb100))

## [2.4.2](https://github.com/grzegorzfranus/ansible-role-chrony/compare/v2.4.1...v2.4.2) (2026-06-01)


### Documentation

* unify README structure and section ordering ([#23](https://github.com/grzegorzfranus/ansible-role-chrony/issues/23)) ([9612d8e](https://github.com/grzegorzfranus/ansible-role-chrony/commit/9612d8ef175c7b1540b1aa1ab75457eab37a4330))

## [2.4.1](https://github.com/grzegorzfranus/ansible-role-chrony/compare/v2.4.0...v2.4.1) (2026-06-01)


### Documentation

* update OS support tables, document variables, and add assertions ([#21](https://github.com/grzegorzfranus/ansible-role-chrony/issues/21)) ([0e7a5cc](https://github.com/grzegorzfranus/ansible-role-chrony/commit/0e7a5cc95f1154ea30e6cedd8a007a3a21c3f1be))

## [2.4.0](https://github.com/grzegorzfranus/ansible-role-chrony/compare/v2.3.0...v2.4.0) (2026-06-01)


### Features

* add support for Debian 13 (Trixie) and Ubuntu 26.04 (Resolute) ([#19](https://github.com/grzegorzfranus/ansible-role-chrony/issues/19)) ([8996330](https://github.com/grzegorzfranus/ansible-role-chrony/commit/8996330401dd328084a26df560615ad1c57d35c9))

## [2.3.0](https://github.com/grzegorzfranus/ansible-role-chrony/compare/v2.2.0...v2.3.0) (2026-05-27)


### Features

* standardize chrony and logrotate configurations ([#16](https://github.com/grzegorzfranus/ansible-role-chrony/issues/16)) ([7979dbe](https://github.com/grzegorzfranus/ansible-role-chrony/commit/7979dbec43248bb5b864e67ae07b07cdb683f3d5))

## [2.2.0](https://github.com/grzegorzfranus/ansible-role-chrony/compare/v2.1.3...v2.2.0) (2026-05-26)


### Features

* modernize and standardize chrony and logrotate templates ([#13](https://github.com/grzegorzfranus/ansible-role-chrony/issues/13)) ([49481eb](https://github.com/grzegorzfranus/ansible-role-chrony/commit/49481ebe2f339fd31c2a9a259970f8987e6e4734))
